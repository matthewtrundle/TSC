...
export const procedures: Procedure[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "This approach is well studied. Peer-reviewed series of Mohs surgery for melanoma performed with MART-1 immunostaining report local recurrence rates below one percent, and large registry studies have found survival after Mohs at least equal to conventional wide excision, with several reporting a modest advantage for early melanoma that has not yet been confirmed in prospective trials.",
